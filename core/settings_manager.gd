...
# Valor por defecto cuando no hay .cfg (primera vez que se abre el juego)
...
func _load_settings() -> void:
	...
	if err != OK:
		...
		# Dejamos is_fullscreen en su default (true) y creamos el .cfg
		# para que a partir de ahora exista.
		_save_settings()
		return
